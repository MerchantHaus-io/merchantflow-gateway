    ...
    >
      ...
      <div className="relative w-full max-w-sm">
        <div className="text-center mb-6">
          ...
          <h1 className="mt-2 text-2xl font-semibold" style={{ color: 'oklch(0.129 0.042 264.695)' }}>
        ...
        <Tabs value={mode} onValueChange={(v) => setMode(v as 'signin' | 'signup')}>
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center">
              <span className="bg-background px-3 text-[10px] uppercase tracking-[0.28em] text-muted-foreground" style={{ background: '#ffffff' }}>or</span>
            </div>
          </div>
