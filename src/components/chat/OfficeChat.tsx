...
const USERS: CRMUser[] = [
  ...
  { email: "jessie@merchanthaus.io", name: rn("yaseen") ?? "Yaseen Sheik", title: "Support", shirtColor: 0x9b30d0, hairColor: 0x2a1a40, skinColor: 0xd4a574, beard: true, beardColor: 0x9a9a9a, scale: 1.08 },
