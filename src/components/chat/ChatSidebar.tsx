              ...
              {onSelectAI && (
                ...
                >
                  <div className="relative">
                    ...
                    <span className="absolute bottom-0 right-0 w-3 h-3 rounded-full border-2 border-[hsl(var(--wa-sidebar-bg))] bg-[hsl(var(--wa-accent))]" />
                  </div>
                  <div className="flex-1 text-left min-w-0">
                    <p className="font-medium text-sm text-[hsl(var(--wa-bubble-in-foreground))] truncate">Atria AI</p>
                    <p className="text-xs text-[hsl(var(--wa-meta))] truncate">AI Assistant · online</p>
                  </div>
                </button>
              )}
